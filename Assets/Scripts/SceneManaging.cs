...
public class SceneManaging : MonoBehaviour
{
    ...
    private void Start() {
        ...
        pauseObject = canvasObject.transform.Find("pauseBtn").gameObject;
        resumeObject = canvasObject.transform.Find("resumeBtn").gameObject;
        soundObject = canvasObject.transform.Find("volBtn").gameObject;
